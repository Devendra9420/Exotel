        ...
        <div class="col-lg-12">
      		<div class="panel">
                ...
                <div class="panel-body">
						...
						<?php 
					if(!empty($followup_booking) && $followup_booking == 1){ 
					$attributes = array('class' => 'form-horizontal group-border hover-stripped', 'id'=>'addedit_form', 'method' => 'post');
                echo form_open_multipart('leads/add_leads', $attributes);	
						echo '<input class="form-control" value="Follow Up" type="hidden" id="source" name="source">';
						echo '<input class="form-control" value="Booking Id '.@$followup_id.'" type="hidden" id="owner" name="owner">';
					}else{
					$attributes = array('class' => 'form-horizontal group-border hover-stripped', 'id'=>'addedit_form', 'method' => 'post');
                echo form_open_multipart('bookings/insert_booking', $attributes); 
					}
					?>
						...
						<div class="form-group col-md-6">
                                <label>Mobile</label>
                                <input class="form-control" placeholder="912345678" id="mobile" type="text" value="<?php echo @$this->session->userdata['customer']['mobile'];?>" name="mobile">
                        </div>
				<?php
					$customer_type='new';
				...
				?>
						...
						<input class="form-control" value="<?php echo @$followup_booking; ?>" type="hidden" id="followup_booking" name="followup_booking"> 	
						<input class="form-control" value="<?php echo @$followup_id; ?>" type="hidden" id="followup_id" name="followup_id"> 		
						...
						<div class="form-group col-md-6"> 
                                ...
                                <input class="form-control" <?php if(!empty($this->session->userdata['customer']['name'])){ echo 'readonly'; } ?> placeholder="Customer Name" id="name" value="<?php echo @$this->session->userdata['customer']['name'];?>" type="text" name="name"> 
                        </div>
                  ...
                  <div class="card-header"> 
                     ...
                     <h4>Address Details</h4>
					  <div id="address_type_div" style="width: 100%;">
				 ...
				 <div class="card-body">
                  ...
                  <div class="card-header"> 
                     ...
                     <h4>Vehicle Details</h4>
					   <div id="customer_vehicle_div" style="width: 100%;">
					   <?php if($this->session->has_userdata('customer')){ 
					...
					<div class="card-header-action col-md-3">
                        <a class="btn btn-icon btn-info float-left" href="javascript:clearVehicle();"><i class="fas fa-plus"></i>Add New</a>
					 ...
					 <div class="row">
						...
						<div class="form-group col-md-6">
					 	...
					 	<div class="form-group col-md-4">
                                ...
                                <input class="form-control year" autocomplete="off" value="<?php echo @$customer_vehicle[0]['yom']; ?>" id="yom"  type="text" name="yom">
                         </div>
						<div class="form-group col-md-4">
				...
				<div class="collapse show" id="service-category-collapse" style="">			
				 <div class="card-body">
					 <div class="row">
						...
						<div class="form-group col-md-6"><label>Service Date:   </label>
						 ...
						 <div class="form-group col-md-6"><label>Time Slot:   </label>
				 ...
				 <div class="card-body">
					 <div class="row">
						...
						<div class="form-group col-md-6"><label>Specific Spares:   </label>
							...
							<div style="display: none;" id="brand_div"></div>
						</div>
				...
				<div class="panel-footer">
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <a href="javascript:reset_on_cancelbtn('<?php echo base_url(); ?>/bookings/add_booking/');" class="btn btn-warning">Cancel</a>
                            </div>
                        </div> 
						</div>	
                    </form>
