<?php if($this->uri->segment(2) == 'list_serviceproviders'){ ?>
    ...
    $(document).ready(function(){
      ...
      var table = $("#listtable").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'serviceproviders/get_serviceproviders'?>", "type": "POST"},
                    columns: [
                        {"data": "id"},
                        {"data": "pic"},
                        {"data": "name"},
          ...
          rowCallback: function(row, data, iDisplayIndex) {
            ...
            var code=$(this).data('serviceprovider_id');
            ...
            $('#ModalUpdate').modal('show');
            			$('[name="serviceprovider_id"]').val(code);
                        $('[name="name"]').val(name);
...
<?php } if($this->uri->segment(2) == 'edit_serviceprovider' || $this->uri->segment(2) == 'add_serviceprovider'){ ?>
...
$(document).ready(function () {
	...
	<?php if($this->uri->segment(2) == 'add_serviceprovider'){ ?>
