                ...
                <div class="col-md-12">
                  <select name="role" class="form-control">
                    ...
                    <?php foreach($admin_roles as $role): ?>
                      <?php if($role['admin_id'] == $admin['admin_id']): ?>
                        <option value="<?= $role['admin_id']; ?>" selected><?= $role['admin_role_title']; ?></option>
                        <?php else: ?>
                          <option value="<?= $role['admin_id']; ?>"><?= $role['admin_role_title']; ?></option>
                        <?php endif; ?>
                      <?php endforeach; ?>
                    </select>
                  </div>
