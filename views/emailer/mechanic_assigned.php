                ...
                <tr>
                  <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md" align="center" style="background-color: #ebf5fa;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
                    ...
                    <div class="o_col-6s o_center o_sans o_text-md o_text-light" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;max-width: 584px;color: #82899a;text-align: center;">
                        ...
                        <tbody>
                          <tr>
                            <td class="o_sans o_text o_text-secondary o_b-primary o_px o_py o_br-max" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;color: #424651;border: 2px solid #126de5;border-radius: 96px;padding-left: 16px;padding-right: 16px;padding-top: 16px;padding-bottom: 16px;">
                              <img src="<?= base_url() ?>assets/images/emailer/person-48-primary.png" width="48" height="48" alt="" style="max-width: 48px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;">
                            </td>
                          </tr>
                          <tr>
                      ...
                      <h2 class="o_heading o_text-dark o_mb-xxs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">Mechanic Assigned</h2>
                ...
                <tr>
                  <td class="o_bg-white o_px-md o_py" align="center" style="background-color: #ffffff;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                    ...
                    <div class="o_col-6s o_sans o_text o_text-secondary o_center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;max-width: 584px;color: #424651;text-align: center;">
                      ...
                      <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">Your service request Id#<?php echo $booking_id; ?> for <?php echo $service_category; ?> scheduled for <?php echo $service_date; ?> at <?php echo $service_time; ?> has been assigned to <?php echo $mechanic_name; ?>. The mechanic will contact you 30 minutes prior to your booking schedule </p>
                        ...
                        <tbody>
                          <tr>
                            <td width="300" class="o_btn o_bg-success o_br o_heading o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #0ec06e;border-radius: 4px;">
                              <!-- <a class="o_text-white" href="" style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">{Link}</a> -->
                            </td>
                          </tr>
                        </tbody>
                      </table>
              ...
              <tbody>
                <tr>
                  <td class="o_re o_bg-white o_px o_pt"  style="font-size: 14;vertical-align: top;background-color: #ffffff;padding-left: 16px;padding-right: 16px;padding-top: 16px;">
                      ...
                      <a href="#" class="list-group-item list-group-item" style="text-align:justify;">1. Our technician post reaching your location will wait for a maximum of 30 minutes. You are requested to handover the keys.</a>
                      <a href="#" class="list-group-item list-group-item" style="text-align:justify;">2. Post handing over the keys, the technician will inspect the vehicle and report the work to be done. </a>
                      <a href="#" class="list-group-item list-group-item" style="text-align:justify;">3. You will receive a the jobcard confirmation link. You will be required to confirm the jobcard for the technician to begin the work. </a>
                      <a href="#" class="list-group-item list-group-item" style="text-align:justify;">4. Please note, there might be an additional requirement of repairs post confirmation of the estimate. In case such a situation arises, you will be requested to reapprove the estimate.</a>
                      <a href="#" class="list-group-item list-group-item" style="text-align:justify;">4. If you are availing service through coupons please ensure, you have understood the terms & conditions. All terms & conditions mentioned strictly apply.</a>
                      <a href="#" class="list-group-item list-group-item" style="text-align:justify;">4. Our team is not allowed to accept bargain requests. All prices are fixed and payable as communicated.</a>
                      <a href="#" class="list-group-item list-group-item" style="text-align:justify;">4. We offer our customers multiple payment options via Credit Card, PayTM, UPI </a>
