                ...
                <tr>
                  <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md" align="center" style="background-color: #ebf5fa;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
                    ...
                    <div class="o_col-6s o_center o_sans o_text-md o_text-light" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;max-width: 584px;color: #82899a;text-align: center;">
                        ...
                        <tbody>
                          <tr>
                            <td class="o_sans o_text o_text-secondary o_b-primary o_px o_py o_br-max" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;color: #424651;border: 2px solid #126de5;border-radius: 96px;padding-left: 16px;padding-right: 16px;padding-top: 16px;padding-bottom: 16px;">
                              <img src="<?= base_url() ?>assets/images/emailer/check-48-primary.png" width="48" height="48" alt="" style="max-width: 48px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;">
                            </td>
                          </tr>
                          <tr>
                      ...
                      <h2 class="o_heading o_text-dark o_mb-xxs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">Booking Completed</h2>
                ...
                <tr>
                  <td class="o_bg-white o_px-md o_py" align="center" style="background-color: #ffffff;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                    ...
                    <div class="o_col-6s o_sans o_text o_text-secondary o_center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;max-width: 584px;color: #424651;text-align: center;">
                      <h4 class="o_heading o_text-dark o_mb-xs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 8px;color: #242b3d;font-size: 18px;line-height: 23px;">Hi, <?php echo $customer_name; ?></h4>
                      <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;text-align:justify;">We thank you for availing services with GarageWorks. Please share your feedback and help us spread the word. We have received an amount of <?php echo $total_amount; ?> via <?php echo $payment_mode; ?> </p>
                      
                      <p style="text-align:justify;">
                          Please click the button below to see your invoice for the services received. 
                      </p>
                        ...
                        <tbody>
                          <tr>
                            <td width="300" class="o_btn o_bg-success o_br o_heading o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #0ec06e;border-radius: 4px;">
                              <a class="o_text-white" target="_blank" href="<?php echo base_url(); ?>paymentsapi/customer_invoice/<?php echo $booking_id; ?>" style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">View Invoice</a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
              ...
              <tbody>
                <tr>
                  <td class="o_re o_bg-white o_px o_pt"  style="font-size: 14;vertical-align: top;background-color: #ffffff;padding-left: 16px;padding-right: 16px;padding-top: 16px;">
                      <h4 class="o_heading o_text-dark o_mb-xxs list-group-item list-group-item-info" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 18px;line-height: 23px;">We did like you to know a few things:</h4>
                      <a href="#" class="list-group-item list-group-item" style="text-align:justify;">1. Please ride your <?php echo $make; ?> <?php echo $model; ?> over the next few days. </a>
                      <a href="#" class="list-group-item list-group-item" style="text-align:justify;">2. There is a 7 day service warranty on the work done. Hence, in case you feel something is not right, do let us know. We will visit you free of cost </a>
                      <a href="#" class="list-group-item list-group-item" style="text-align:justify;">3. The warranty and free visit do not apply if the complaints are due to the recommended repairs not approved by you. </a>
                      <a href="#" class="list-group-item list-group-item" style="text-align:justify;">4. We offer various other services for you to ensure you have a hassle free two-wheeler ownership. Look forward to serving you. </a>
          ...
          <td class="o_bg-light o_px-xs" style="background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;">
            ...
            <table class="o_block-lg" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 800px;margin: 0 auto;">
              <tbody>
                <tr>
                  <td class="o_re o_bg-white o_px o_pt"  style="font-size: 14;vertical-align: top;background-color: #ffffff;padding-left: 16px;padding-right: 16px;padding-top: 16px;">
                      <h5 class="o_heading o_text-dark o_mb-xxs list-group-item list-group-item-info" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 14px;line-height: 23px;text-align:center;"> 
                        <br>We are here to ensure you have a pleasant ride. 
                        <br>Stay Safe, Ride Safe.
                ...
                <tr>
                  <td class="o_re o_bg-dark o_px o_pb-lg" align="center" style="font-size: 0;vertical-align: top;background-color: #242b3d;padding-left: 16px;padding-right: 16px;padding-bottom: 32px;">
                    ...
                    <div class="o_col o_col-2 o_col-full" style="display: inline-block;vertical-align: top;width: 100%;max-width: 200px;">
                      <div style="font-size: 32px; line-height: 32px; height: 32px;">&nbsp; </div>
                      <div class="o_px-xs o_sans o_text-xs o_center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;text-align: center;padding-left: 8px;padding-right: 8px;">
                        <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-dark_light" href="https://garageworks.in/contact.html" target="_blank" style="text-decoration: none;outline: none;color: #a0a3ab;"><strong style="color: #a0a3ab;">Contact Us</strong></a></p>
                      </div>
                    </div>
                    <!--[if mso]></td></tr></table><![endif]-->
                  </td>
