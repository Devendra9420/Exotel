...
<?php
if ($this->uri->segment(1) != "bookings" && ($this->uri->segment(2) == "index")) { ?>
...
<?php if($this->uri->segment(1) == "customer") {  
  $this->load->view('customer/customer_js');
  } ?>
<?php if($this->uri->segment(1) == "users") {  
  $this->load->view('users/users_js');
  } ?>

<?php if($this->uri->segment(1) == "serviceproviders") {  
  $this->load->view('service_providers/serviceproviders_js');
  } ?> 

<?php if($this->uri->segment(1) == "spares") {  
  $this->load->view('spares/spares_js');
  } ?> 
...
<?php 
	...
	$this->load->view('bookings/bookings_js');  
	}
?> 

 <?php if($this->uri->segment(1) == "feedbacks") {  
	$this->load->view('feedbacks/feedback_js');  
	}
?> 
<?php if($this->uri->segment(1) == "leads") {  
	$this->load->view('leads/leads_js');  
	}
?> 
<?php if($this->uri->segment(1) == "complaints") {  
	$this->load->view('complaints/complaints_js');  
	}
?> 
<?php if($this->uri->segment(1) == "offers") {  
	$this->load->view('offers/offers_js');  
	}
?> 
...
<?php
if ($this->uri->segment(2) == "view_invoice") {  ?> 
...
$(document).ready(function() { 
		...
		swal('Great', "<?= $this->session->flashdata("success") ?>", 'success', { buttons: false, timer: 2000,  }); 
        <?php elseif($this->session->flashdata("error")): ?>
        swal('Oops', "<?= $this->session->flashdata("error") ?>", 'error', { buttons: false, timer: 2000,  }); 
        <?php elseif($this->session->flashdata("info")): ?>
         swal('Ok!', "<?= $this->session->flashdata("info") ?>", 'info', { buttons: false, timer: 2000,  }); 
        <?php elseif($this->session->flashdata("warning")): ?> 
         swal('Ahh!', "<?= $this->session->flashdata("warning") ?>", 'warning', { buttons: false, timer: 2000,  }); 
        <?php endif;?>
    });
</script>
</body>
