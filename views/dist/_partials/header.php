...
$this->load->view('dist/_partials/custom_css');
...
}elseif ($this->uri->segment(2) != "login" && $this->uri->segment(2) != "forgot_password"&& $this->uri->segment(2) != "register" && $this->uri->segment(2) != "reset_password" && $this->uri->segment(2) != "errors_503" && $this->uri->segment(2) != "errors_403" && $this->uri->segment(2) != "errors_404" && $this->uri->segment(2) != "errors_500" && $this->uri->segment(2) != "utilities_contact" && $this->uri->segment(2) != "utilities_subscribe") {
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1><?= isset($page_title)? $page_title : make_first_capital($this->uri->segment(1)); ?></h1>
            <div class="section-header-breadcrumb" style="display: none;">
