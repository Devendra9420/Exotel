...
<h1><img src="<?= base_url() ?>logo.png"></h1>
  ...
  <div class="tab">
        <fieldset >      
                <legend>Any tips on how we can score 5 ?</legend>      
                <input placeholder="Any Tips" oninput="this.className = ''" name="tips">
  ...
  <div style="overflow:auto;">
    <div style="float:right; margin: auto; text-align: center;">
