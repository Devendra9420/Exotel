<?php echo form_open_multipart(base_url() . 'index.php/claims/claims_estimate_form', array('method' => 'post')); ?>
<div class="row">
...
<div class="col-lg-12">
         ...
         <input type="text" value="<?php echo date('m/d/Y'); ?>" size="16" required name="estimate_date" class="form-control form-control-inline input-medium datepicker">
                              
                        </div>
                        
                        <div class="col-lg-6">
                            <span>Estimate No: </span>
                                 <input type="text" value="<?php echo $surveyDetail['id']; ?>" size="16" id="estimate_no" required name="estimate_no"
	...
	<?php 
						...
						$where = array('claim_id' => $surveyDetail['id']);
						$getClaimDetailsvalue =$this->Main_model->single_row('claim_survey_details', $where, 's');
						...
						?>
						 ...
						 <h3>Customer Details:</h3>
							 <ul class="list-unstyled">
								...
								<li>Vehicle Reg No:  <?= $getClaimDetailsvalue['regno']; ?> </li>
    ...
    <div class="col-lg-12">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body" id="rows-list">
               ...
               <div class="box-header with-border text-center sbold uppercase" style="background-color: black; color: white;"> <h3 class="box-title"> <span class="caption-subject sbold uppercase"  style="color: white;">Service/Repairs</span></h3> </div> 
				...
				<table class="table table-striped table-hover table-bordered dataTable" id="servicetable" aria-describedby="editable-sample_info"> 
                   ...
                   <div style="text-align:right">
						...
						<span style=""><button class="btn btn-success" type="submit">Create Estimate</button></span>
                    </div>
                </div>
