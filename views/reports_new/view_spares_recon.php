<div class="row">
    <div class="col-md-12">
        ...
        <div class="box">
            <div class="box-title">
                <h4><i class="icon-reorder"></i> Spares Recon Log </h4>
						<span class="tools">
            ...
            <div class="box-body">
                <!-- BEGIN FORM-->
                    ...
                    <?php echo form_open('reports/export_spares_recon',array('class'=>"form-horizontal form-bordered form-validate",'method'=>'post'))?>
                    <div class="row">
                        <div class="col-lg-6">
                    ...
                    <div class="row ">
                        <div class="col-md-8 col-md-offset-2">
                            <form method="post" action="#">
							 ...
							 <?= form_open_multipart(base_url() . 'index.php/reports/export_spares_recon', array('method' => 'POST', 'class' => 'form-horizontal')) ?>
                    ...
                    <div class="row ">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <main class="invoice_report">
                                ...
                                <h4>Complaints Log from: <strong><?php echo $start ?></strong> to
