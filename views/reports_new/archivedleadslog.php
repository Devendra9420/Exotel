<div class="row">
    <div class="col-md-12">
        ...
        <div class="box">
            <div class="box-title">
                <h4><i class="icon-reorder"></i>Archived Leads Log </h4>
						<span class="tools">
            ...
            <div class="box-body">
                <!-- BEGIN FORM-->
                    ...
                    <?php echo form_open('reports/export_archivedleadslog',array('class'=>"form-horizontal form-bordered form-validate",'method'=>'post'))?>
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <form method="post" action="#">
                                <div class="btn-group pull-right">
									<?= form_open_multipart(base_url() . 'index.php/reports/export_archivedleadslog', array('method' => 'POST', 'class' => 'form-horizontal')) ?>
