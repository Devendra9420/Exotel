			...
			<div class="section-body"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-12"> 
                           ...
                           <h4>  Travel from: <strong><?= date('d-m-Y', strtotime($start_date1)); ?></strong> to <strong><?= date('d-m-Y', strtotime($end_date1)); ?></strong>
                                </h4>
                                <br>
						...
						<table class="table table-striped table-hover table-bordered">
							<thead> 
                                        <tr style="background-color: #ECECEC">
                                            ...
                                            <th class="desc text-center">Avg Distance</th> 
                                        </tr>
                                        </thead>
							<tbody>
							<tr><td class="desc text-center"><?= number_format($travel['avg_travel'],2); ?> Kms</td></tr>	
							</tbody>
							</table>
						</div>
