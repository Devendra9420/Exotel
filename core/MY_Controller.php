...
class MY_Controller extends CI_Controller
{
	...
	var $jobcardViewCreateEditPermission = array(1, 2, 11);
	var	$BookingProcessViewCreateEditPermission = array(1, 2, 11);
	var	$bookingReschCancelViewCreateEditPermission = array(1, 2, 10, 11); 
    ...
    public function header($title = '')
    {
       ...
       // $data['parent_nav'] = $this->Menus->fetch_parent_navi();
        ...
        $data['title'] = $this->general_settings['company_name']; //$data['company']->name;
		$data['page_title'] = $title; //$data['company']->name;
        $data['content'] = "";
    ...
    public function main_content()
    {
        ...
        $data['total_mechanics'] = $this->General->count_all('mechanic');
        ...
        if (!empty($menu_id) && $this->session->userdata("group_id") != 1) {
            ...
            foreach ($permissionResult as $permissionResults) {
                ...
                if ($permissionResults->PER_INSERT == 1) {
                    ...
                    $this->savePermission = "<input type='submit' value='Save' class='btn btn-success btn-large formsubmit_button' >";
            ...
            $this->savePermission = "<input type='submit' value='Save' class='btn btn-success formsubmit_button' >";
